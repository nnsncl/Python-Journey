...
# Combine names and primary_types with zip()
...
#Using set is faster than an list

# NOT RECOMANDED APPROACH WITH A FOR LOOP
...
highest_hp_pokemon2 = [(name, hp, zcore) for name, hp, zcore in poke_zscores2 if zcore > 2]
